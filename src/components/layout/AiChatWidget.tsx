...
const SAMPLE_CONVERSATION: ChatMessage[] = [
  {
    id: "msg-1",
    role: "assistant",
    body: "Salam! Main Bilal hun, Ibrahim Mobile Store ka assistant. Aap koi bhi sawal Urdu, Roman Urdu ya English mein pooch sakte hain.",
    language: "ur-Latn",
  },
  {
    id: "msg-2",
...
function EscalationFooter() {
  return (
    <a
      href={buildWhatsAppLink(ESCALATE_MESSAGE)}
      target="_blank"
