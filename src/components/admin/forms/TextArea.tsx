    ...
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        ...
        className={classNames(
          "rounded-[var(--radius-md)] border border-[var(--color-ink-200)] bg-[var(--color-surface)] px-3 py-2.5 text-sm text-[var(--color-ink-900)] placeholder:text-[var(--color-ink-400)] focus:border-[var(--color-ink-400)] focus:outline-none",
          className,
        )}
      />
