...
export function SelectField({ label, options, hint, id, className, ...rest }: SelectFieldProps) {
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative flex h-10 items-center rounded-[var(--radius-md)] border border-[var(--color-ink-200)] bg-[var(--color-surface)] focus-within:border-[var(--color-ink-400)]">
        <select
          id={fieldId}
          {...rest}
