  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <header className="space-y-3">
        <p className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-[var(--color-accent-700)]">
          <Sparkles size={14} />
          Live offers
        </p>
        <h1 className="font-semibold text-5xl leading-[0.95] tracking-tight text-[var(--color-ink-900)] sm:text-6xl">
