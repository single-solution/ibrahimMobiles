    ...
    <div className="overflow-hidden rounded-[var(--radius-lg)] border border-[var(--color-ink-100)] bg-[var(--color-surface)] shadow-[var(--shadow-sm)]">
      <div className="flex items-end justify-between gap-3 px-4 pt-4 md:px-5">
        <div>
          ...
          <p className="mt-1 text-[24px] font-semibold leading-none tracking-tight text-[var(--color-ink-900)] sm:text-[26px]">
            {totalLabel}
          </p>
          <p className="mt-1 text-[11.5px] text-[var(--color-ink-500)]">Last 30 days</p>
        </div>
        <div className="text-right">
          <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[var(--color-ink-400)]">
            Peak day
          </p>
      ...
      <div className="mt-3 px-1.5 pb-1.5">
        {hasData ? (
          ...
          <div className="grid h-24 place-items-center text-[12px] text-[var(--color-ink-400)]">
