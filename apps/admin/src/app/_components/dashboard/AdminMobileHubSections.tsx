      ...
      rows: [
        {
          ...
          icon: Package,
          trailing:
            kpis.lowStockVariants > 0
              ? `${kpis.lowStockVariants} low stock`
              : `${kpis.modelsListed} listed`,
        },
...
function HubGroupCard({ group }: { group: HubGroup }) {
  return (
    <div>
      <p className="px-1 pb-1.5 text-[0.625rem] font-semibold uppercase tracking-[0.12em] text-[var(--color-ink-400)]">
        {group.title}
      </p>
