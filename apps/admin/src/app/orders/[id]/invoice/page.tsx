    ...
    <div className="mx-auto max-w-3xl bg-white p-8 text-black print:p-0">
      <div className="mb-8 flex items-start justify-between border-b border-gray-200 pb-4">
        ...
        <div className="text-right">
          <p className="text-xl font-bold">Ibrahim Mobiles</p>
          <p className="text-sm text-gray-500">Professional Sales & Service</p>
          <p className="text-sm text-gray-500">www.ibrahimmobiles.com</p>
        </div>
      </div>
          ...
          <tbody className="divide-y divide-gray-200">
            {order.items.map((item) => (
              <tr key={String(item._id)}>
                ...
                <td className="py-3 pl-2 text-right font-semibold text-gray-900">
      ...
      <div className="mt-16 border-t border-gray-200 pt-8 text-center text-xs text-gray-500 print:mt-32">
        <p>Thank you for shopping with Ibrahim Mobiles!</p>
