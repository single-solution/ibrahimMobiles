...
export function CustomerAccessCodeDialog({
  isOpen,
  customerName,
  phoneNumber,
  code,
    ...
    >
      <div className="space-y-4">
        <div className="flex flex-col items-center gap-3 rounded-[var(--radius-md)] border border-[var(--color-ink-100)] bg-[var(--color-canvas-deep)] px-4 py-6 text-center">
          ...
          <span className="font-mono text-[2rem] font-bold tracking-[0.35em] text-[var(--color-ink-900)]">
            {code}
          </span>
          <Button
            variant="outline"
        ...
        <ul className="space-y-1.5 text-xs leading-relaxed text-[var(--color-ink-600)]">
          <li>
            ...
            <span className="font-semibold text-[var(--color-ink-800)]">{phoneNumber}</span>
          </li>
          <li>
            Valid for <strong>{expiresInMinutes} minutes</strong>, single use. Issuing a new code
            cancels this one.
          </li>
