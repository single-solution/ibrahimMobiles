...
export function AttributeOptionTabRow({
  options,
  selectedKeys,
  onSelect,
  ariaLabel,
  trailingOption,
}: AttributeOptionTabRowProps) {
...
export const ATTRIBUTE_DIMENSION_LABEL_CLASS =
  "text-[9.5px] font-semibold uppercase tracking-[0.2em] text-[var(--color-ink-500)] md:text-[10.5px]";
