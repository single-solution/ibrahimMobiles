		...
		>
			<div className="flex items-start gap-2 px-2 py-2">
				...
				>
					...
					{hasErrors ? (
						<p className="mt-0.5 truncate text-[10px] font-semibold text-[var(--color-rose-700)]">
							{errorCount === 1 ? "Needs attention" : `${errorCount} fields need attention`}
						</p>
					) : null}
				</button>
				<div className="flex shrink-0 flex-col items-end gap-1">
					...
					{hasErrors ? (
						<span
							aria-hidden
							className="grid size-5 place-items-center rounded-full bg-[var(--color-rose-600)] text-[10px] font-bold text-white"
						>
