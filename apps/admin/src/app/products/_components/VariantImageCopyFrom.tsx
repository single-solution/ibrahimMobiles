...
import { cloneGalleryImages, type GalleryImage } from "@/components/shared/uploads/imageStaging";
...
interface VariantImageCopyFromProps {
  ...
  onApply: (images: GalleryImage[]) => void;
}
  ...
  return (
    <div className="mb-2 flex flex-col gap-1.5 rounded-[var(--radius-md)] border border-dashed border-[var(--color-ink-200)] bg-[var(--color-canvas-deep)]/50 px-2.5 py-2">
      ...
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        <button
          type="button"
          onClick={() => onApply(cloneGalleryImages(picked.images))}
