...
export default function AdminErrorPage({ error, reset }: ErrorPageProps) {
  ...
  return (
    <main className="mx-auto flex min-h-[60vh] max-w-xl flex-col items-center justify-center px-4 py-16 text-center">
      <p className="text-[10px] font-semibold uppercase tracking-[0.25em] text-[var(--color-danger-500)]">
        Something went wrong
      </p>
      <h1 className="mt-2 text-3xl font-semibold tracking-tight text-[var(--color-ink-900)]">
        We hit a snag.
      </h1>
