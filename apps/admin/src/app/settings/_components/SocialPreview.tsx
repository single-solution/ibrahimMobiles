...
export function SocialPreview({ resolved, siteUrl }: SocialPreviewProps) {
  ...
  return (
    ...
    >
      <p className="text-[11px] font-medium uppercase tracking-wide text-[var(--color-ink-500)] mb-3">
      ...
      <div className="overflow-hidden rounded-[var(--radius-md)] border border-[var(--color-ink-100)] bg-[#f8f9fa] shadow-sm">
        ...
        <div className="p-3">
          <p className="mb-0.5 truncate text-[11px] font-medium uppercase text-[var(--color-ink-500)]">
            {domain}
          </p>
          <p className="mb-1 truncate text-sm font-semibold text-[var(--color-ink-900)]">
            {title}
          </p>
          <p className="line-clamp-2 text-xs text-[var(--color-ink-600)]">
            {description}
          </p>
        </div>
      </div>
