		...
		<div ref={containerRef} className="flex shrink-0 flex-col gap-1.5">
			...
			<span className="whitespace-nowrap text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--color-ink-700)]">
				...
				{optional ? (
					...
					<span className="ml-1 font-normal normal-case tracking-normal text-[var(--color-ink-400)]">
			...
			>
				...
				{isActive ? (
					...
					<ChevronDown
						...
						className={classNames("shrink-0 transition-transform", isOpen && "rotate-180")}
