...
export const ROLE_DESCRIPTIONS: Record<UserRole, string> = {
  ...
  business_manager:
    "Day-to-day operations lead. Manages products, orders, customers, loyalty, chats, and store settings. Cannot manage the team or run destructive data cleanup.",
  product_manager:
    "Catalog focus. Creates and edits products, categories, brands, and media. Does not see orders, customers, settings, or chat.",
  marketing_manager:
    "Promotions & merchandising. Manages offers, categories, brands, and media. Cannot edit individual products, orders, or customers.",
  support_staff:
...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  {
    ...
    description: "Phones, categories, brands, and storefront merchandising.",
    permissions: [
      "product_view",
      "product_create",
      "product_update",
