        ...
        <div className="mx-auto w-full max-w-3xl p-4 md:p-5">
          <div className="overflow-hidden rounded-[var(--radius-lg)] border border-[var(--color-ink-100)] bg-[var(--color-surface)] px-4 shadow-[var(--shadow-sm)] md:px-6">
            {Array.from({ length: 2 }).map((_, section) => (
              <div
                key={section}
                className="grid gap-5 border-b border-[var(--color-ink-100)] py-6 first:pt-6 last:border-b-0 lg:grid-cols-[220px_minmax(0,360px)] lg:gap-10"
              >
                <div>
      ...
      <div className="mx-auto w-full max-w-3xl p-4 md:p-5">
        <div className="overflow-hidden rounded-[var(--radius-lg)] border border-[var(--color-ink-100)] bg-[var(--color-surface)] px-4 shadow-[var(--shadow-sm)] md:px-6">
          <form onSubmit={handleProfileSubmit}>
            <FormSection
              title="Profile"
              description="Update how you appear in the admin console. Email is used for password resets."
            >
              <TextField
                label="Full name"
                value={name}
          ...
          <form id="password" onSubmit={handlePasswordSubmit} className="scroll-mt-4">
            <FormSection
              title="Password"
              description="Choose a new password for signing in to the admin console. Minimum 8 characters."
            >
              <TextField
                label="New password"
                type="password"
