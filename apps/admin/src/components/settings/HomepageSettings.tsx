      ...
      {renderSaveable({
        ...
        children: (
          <>
            ...
            <FormSection
              title="Grades"
              description="Optional — when set, the hero only shows products with at least one variant in one of these grades. Useful for spotlighting brand-new stock or recent trade-ins."
            >
              <TaxonomyPickerHeader
