...
export function SaveBar({
  ...
  return (
    <div className="sticky bottom-0 z-20 -mx-6 mt-8 flex flex-wrap items-center justify-between gap-3 border-t border-[var(--color-ink-100)] bg-[var(--color-canvas)]/85 px-6 py-3 backdrop-blur">
