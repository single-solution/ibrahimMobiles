...
export function NavigationProgress() {
  ...
  return (
    <div
      ...
      className="pointer-events-none fixed inset-x-0 top-0 z-[60] h-[2px] overflow-hidden transition-opacity duration-200 data-[active=false]:opacity-0 data-[active=true]:opacity-100"
    >
