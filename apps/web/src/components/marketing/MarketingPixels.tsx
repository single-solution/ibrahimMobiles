 ...
 * - Loading strategy is `afterInteractive` to keep LCP unaffected; pixels
 *   only fire after first paint on most pages.
 */
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      {validGa4 ? (
        <>
          <Script
            id="ga4-loader"
            src={`https://www.googletagmanager.com/gtag/js?id=${validGa4}`}
 ...
 */
export function MarketingPixelsNoScript({
  googleTagManagerId,
}: Pick<MarketingPixelsProps, "googleTagManagerId">) {
  const gtm = clean(googleTagManagerId).toUpperCase();
