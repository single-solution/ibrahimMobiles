 ...
 */
export function resolveListingVariant(product: Product, options?: { gradeSlugs?: string[] }): Variant {
 ...
 */
export function getProductGradesInDisplayOrder(product: Product, categoryGrades: GradeDescriptor[]): string[] {
