        ...
        >
          ...
          <ul className="space-y-3 p-4 text-[13px] text-[var(--color-ink-700)] md:p-5">
            ...
            <li className="flex items-start gap-3">
              ...
              <p>
                <strong className="text-[var(--color-ink-900)]">Same day</strong> — we send proof
                of the packed item on request before dispatch.
              </p>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-1 size-1.5 rounded-full bg-[var(--color-ink-300)]" />
              <p>
                <strong className="text-[var(--color-ink-900)]">2–4 working days</strong> — tracked
                courier delivers door-to-door nationwide.
              </p>
            </li>
          </ul>
        </Card>
