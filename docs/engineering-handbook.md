...
Project-specific engineering standards, optimizations inventory, and vibeCodingRules alignment notes for Ibrahim Mobiles. **Read this before adding features** so patterns stay consistent and regressions are avoided.
