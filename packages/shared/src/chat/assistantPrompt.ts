...
export const STORE_HOW_IT_WORKS: readonly string[] = [
  ...
  "Getting around the site: /shop to browse (filter by category, price, condition), /deals for current offers, /cart and /checkout to buy, and /account for their orders, saved addresses, and loyalty points. Order status and the dispatch video are on their order page inside their account.",
